...
class InternalBlocks(models.Sequential):
    def __init__(self, num_blocks, num_neuron_lin=120, num_neuron_batch=120, num_neuron_bin=120, input_shape=None, training=False):
        super().__init__()
...
class OutputBlocks(models.Sequential):
    def __init__(self, num_neuron_lin=2, num_neuron_argmax=1):
        super().__init__()
        self.add(LinearLayer(num_neurons=num_neuron_lin))
